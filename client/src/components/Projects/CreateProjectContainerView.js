...
export const CreateProjectContainerView = ({handleOnChange, value, handleOnClick}) => {
    return (
        <div>
            <form>
                <div className="mb-3">
                ...
                <Link type="submit" className="btn btn-primary" onClick={handleOnClick}>Create Project</Link>
